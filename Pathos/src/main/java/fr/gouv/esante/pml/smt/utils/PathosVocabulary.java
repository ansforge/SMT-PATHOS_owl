...
public enum PathosVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** profils_retenus.         */ profils_retenus            ("profils_retenus",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  PathosVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.PATHOS.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.PATHOS.toString(), localname);
  }

  private static Stream<PathosVocabulary> stream() {
